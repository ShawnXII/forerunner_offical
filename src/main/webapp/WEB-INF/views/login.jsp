...
<body>
	...
	<form id="loginForm" class="form-signin" action="/login"
		method="post">
		...
		<div id="themeSwitch" class="dropdown">
			<a class="dropdown-toggle" data-toggle="dropdown" href="#"
				style="color: #fff">默认主题<b class="caret"></b></a>
	...
	<div class="footer">
		Copyright &copy; 2012-2016 <a
			href="#">Forerunner</a>
		- Powered By <a href="#" target="_blank">JeeSite</a>V1.0.0
	</div>
	<script src="/flash/zoom.min.js" type="text/javascript"></script>
</body>
</html>