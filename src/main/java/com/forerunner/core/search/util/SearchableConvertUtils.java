package com.forerunner.core.search.util;
...
public final class SearchableConvertUtils {
	 ...
	 * "com.sinosoft.arch.core.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
					...
					try {
						...
						throw new SearchException(
								"conversionService is null, " + "search param convert must use conversionService. "
										+ "please see [com.sinosoft.arch.core.common.entity.search.utils."
